...
const STEPS = [
  { num: '01', title: 'Set Up Mirror', desc: 'Define your username, details, and 5 key interests.', icon: <Sparkles className="w-5 h-5 text-primary" /> },
  ...
  { num: '04', title: 'Unlock Insight', desc: 'View your dimensional chart, custom roasts & compliments.', icon: <BarChart3 className="w-5 h-5 text-primary" /> },
]
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden text-text-primary">
      ...
      <header className="max-w-6xl mx-auto px-6 pt-6 relative z-50">
        <nav className="glass-panel flex items-center justify-between px-6 py-4 rounded-3xl border border-border shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link 
              href="/create" 
              className="flex items-center gap-1.5 px-5 py-2.5 bg-gradient-to-r from-primary to-secondary text-white rounded-2xl font-bold text-xs hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-md shadow-primary/10"
            >
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface border border-border text-primary font-bold text-xs mb-6.5 shadow-sm">
          ...
          <h1 className="font-display font-black text-4xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight leading-[1.08] mb-6 text-text-primary">
            ...
            <span className="text-gradient drop-shadow-[0_0_30px_rgba(124,58,237,0.08)]">really see you.</span>
          </h1>
          
          <p className="text-text-secondary text-sm sm:text-base md:text-lg max-w-xl mx-auto mb-10 leading-relaxed font-semibold">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4.5 max-w-sm mx-auto">
            <Link 
              href="/create" 
              className="flex items-center justify-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-primary to-secondary text-white rounded-2xl font-bold text-base hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-primary/15"
            >
          ...
          >
            ...
            <div className="glass-card p-6 md:p-8 border border-border relative shadow-xl overflow-hidden text-left bg-surface/90">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 pb-5 border-b border-border">
                ...
                {/* Tabs inside preview */}
                <div className="flex bg-background/80 p-1 rounded-xl border border-border gap-1 self-stretch sm:self-auto relative">
                ...
                <AnimatePresence mode="wait">
                  {previewTab === 'card' && (
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[11px] px-2.5 py-1 bg-background border border-border rounded-lg font-bold text-text-secondary">
                  ...
                  {previewTab === 'roast' && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -5 }}
                      className="text-left p-5 bg-secondary/5 border border-secondary/15 rounded-2xl relative"
                    >
                      ...
                      <p className="text-xs md:text-sm italic text-secondary-hover font-semibold leading-relaxed mt-2.5">
                  ...
                  {previewTab === 'compliment' && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -5 }}
                      className="text-left p-5 bg-accent/5 border border-accent/15 rounded-2xl relative"
                    >
                      <div className="absolute -top-2.5 left-4 px-2.5 py-0.5 bg-accent text-white text-[9px] font-bold uppercase rounded-full tracking-wider">
                        Compliment Preview 💖
                      </div>
                      <p className="text-xs md:text-sm italic text-text-primary font-semibold leading-relaxed mt-2.5">
      ...
      {/* Bento Grid Features */}
      <section className="max-w-5xl mx-auto px-6 py-20 relative z-10 border-t border-border">
        <div className="text-center mb-14">
          <h2 className="font-display text-3xl md:text-5xl font-black mb-3 text-text-primary">What you get</h2>
          <p className="text-sm md:text-base text-text-secondary font-semibold">Fully-custom features engineered for growth loops.</p>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 relative z-10 border-t border-border">
        <div className="text-center mb-14">
          ...
          <p className="text-sm md:text-base text-text-secondary font-semibold">Simple steps to launch your social mirror.</p>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 relative z-10 border-t border-border">
        <div className="text-center mb-14">
          ...
          <p className="text-sm md:text-base text-text-secondary font-semibold">See how other people are using Social Mirror.</p>
        </div>
      ...
      {/* Footer CTA */}
      <section className="max-w-3xl mx-auto px-6 py-24 text-center relative z-10 border-t border-border">
        <h2 className="font-display text-3xl md:text-5xl font-black mb-4 text-text-primary leading-tight">
          Ready to see your <br /><span className="text-gradient drop-shadow-[0_0_30px_rgba(124,58,237,0.1)]">Social Mirror</span>?
        </h2>
        <p className="text-sm md:text-base text-text-secondary mb-8 font-semibold">It takes 30 seconds. No sign-up required.</p>
        <Link 
          href="/create" 
          className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-primary to-secondary text-white rounded-2xl font-bold hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-primary/10"
        >
